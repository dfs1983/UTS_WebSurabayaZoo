...
<body>
    ...
    <div class="container-fluid mt-4 mb-4 bg-light text-black">
        <h3 style="text-align: center; padding: 15px;"><b>KOLEKSI SATWA BURUNG</b></h3>
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination justify-content-center pagination-lg">
                <li class="page-item">
                    <a class="page-link text-success" href="aves.php" aria-label="Previous">
                        <span aria-hidden="true">&laquo;</span>
                    </a>
                </li>
                <li class="page-item"><a class="page-link text-success" href="aves.php">1</a></li>
                <li class="page-item active"><a class="page-link bg-success" href="aves2.php">2</a></li>
                <li class="page-item disabled">
                    <a class="page-link text-success" href="aves2.php" aria-label="Next">
