...
<body>
    ...
    <div class="container-fluid mt-4 bg-light text-black">
        <h3 style="text-align: center; padding: 15px;"><b>KOLEKSI SATWA SERANGGA</b></h3>
        <h1 style="text-align: center; padding-bottom: 15px;">C O M I N G &nbsp; S O O N</h1>
    </div>
    <!-- Footer -->
